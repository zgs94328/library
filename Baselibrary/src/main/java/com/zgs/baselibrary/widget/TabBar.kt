...
class TabBar @JvmOverloads constructor(context: Context, attributeSet: AttributeSet? = null, defStyleAttr: Int = 0)
    ...
    var iconWidth = dp2px(20)
    var iconHeight = dp2px(20)
    var iconPosition = 1
    var selectedColor = Color.RED
    var normalColor = Color.BLACK
    var normalTextSize = sp2px(14)
    var selectTextSize = sp2px(14)
    var tabHeight = 0
    var iconSpace = dp2px(2) //图片和文字间距
    ...
    var pagerChangeListener = object : ViewPager2.OnPageChangeCallback() {
    ...
    fun setupWithViewPager(pager: ViewPager2) {
        vp = pager
        pager.registerOnPageChangeCallback(pagerChangeListener)
    }
...
//        vp?.setCurrentItem(tabIndex, false)
    ...
    override fun onDetachedFromWindow() {
        ...
        vp?.unregisterOnPageChangeCallback(pagerChangeListener)
    }
