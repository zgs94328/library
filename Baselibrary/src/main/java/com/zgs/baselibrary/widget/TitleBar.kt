...
class TitleBar @JvmOverloads constructor(context: Context, attributeSet: AttributeSet? = null, defStyleAttr: Int = 0)
    ...
    private fun applySelf() {
        ...
        if (paddingLeft == 0) setPadding(dp2px(1), paddingTop, paddingRight, paddingBottom)
        if (paddingRight == 0) setPadding(paddingLeft, paddingTop, dp2px(1), paddingBottom)
    }
    ...
    override fun dispatchDraw(canvas: Canvas) {
        ...
        if (bottomLine != 0) {
            ...
            canvas.drawRect(Rect(0, measuredHeight - dp2px(1), measuredWidth, measuredHeight), paint)
        }
    }
